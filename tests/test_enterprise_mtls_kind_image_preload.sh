  ...
  image:inspect)
    if [ "$#" -eq 5 ] && [ "$3" = '--format' ] && [ "$4" = '{{.Os}}/{{.Architecture}}' ] && [ "$5" = 'sha256:preload-test-node' ]; then
      ...
      case "$5" in
        ...
        postgres:16-alpine) digest='sha256:3c5c8892d184f738f4fe282d14ddaa613a38f00f4189d2d94725ebe6f2909ddb' ;;
        ...
        sha256:5555555555555555555555555555555555555555555555555555555555555555) digest='sha256:3c5c8892d184f738f4fe282d14ddaa613a38f00f4189d2d94725ebe6f2909ddb' ;;
