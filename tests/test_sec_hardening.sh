...
VEIL_REKOR_URL=https://rekor.sigstore.dev
VEIL_TSA_URL=https://freetsa.org/tsr
...
VEIL_GATEWAY_SIGNING_KEY=$SEED_GW
VEIL_MANIFEST_SIGNING_KEY=$(gen_seed)
VEIL_WITNESS_PUBLIC_KEY=$PUB_WIT
VEIL_BRIDGE_PUBLIC_KEY=$PUB_BRIDGE
VEIL_SANITIZER_PUBLIC_KEY=$PUB_SAN
VEIL_AUDIT_PUBLIC_KEY=$PUB_AUDIT
VEIL_SANDBOX_B_PUBLIC_KEY=$PUB_SBB
VEIL_SANDBOX_B_SIGNING_KEY=$SEED_SBB
VEIL_GATEWAY_PUBLIC_KEY=$PUB_GW
