...
# artifacts (keys/image-digests-0.5.2.txt) under signed_artifacts, in lockstep.
...
done < "$ROOT/keys/image-digests-0.5.2.txt"
...
echo "B1-S3: image_digests block in lockstep with keys/image-digests-0.5.2.txt (via parser) + dashboard manifest synced"
